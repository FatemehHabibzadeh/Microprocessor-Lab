...
; 0000 0026 DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (1<<DDA3) | (1<<DDA2) | (1<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(15)
	OUT  0x1A,R30
...
; 0000 0092             PORTA = 6;
	LDI  R30,LOW(6)
	RCALL SUBOPT_0x0
; 0000 0093             delay_ms(5000);
; 0000 0094             PORTA = 9;
	LDI  R30,LOW(9)
	RJMP _0xA
; 0000 0095             delay_ms(5000);
; 0000 0096         }else{
_0x7:
; 0000 0097             PORTA = 9;
	LDI  R30,LOW(9)
...
; 0000 0099             PORTA = 6;
	LDI  R30,LOW(6)
	RCALL SUBOPT_0x0
; 0000 009A             delay_ms(5000);
; 0000 009B             PORTA = 10;
	LDI  R30,LOW(10)
	RCALL SUBOPT_0x0
; 0000 009C             delay_ms(5000);
; 0000 009D             PORTA = 5;
	LDI  R30,LOW(5)
_0xA:
	OUT  0x1B,R30
; 0000 009E             delay_ms(5000);
	LDI  R26,LOW(5000)
	LDI  R27,HIGH(5000)
	CALL _delay_ms
; 0000 009F       }
